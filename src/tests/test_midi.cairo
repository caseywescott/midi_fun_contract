...
mod tests {
    ...
    // TODO: JSON serialization test removed due to missing JSON dependencies
// This test should be re-implemented when JSON functionality is properly integrated
}
